...
func main() {
	inputFile, _ := os.Open("C:\\Users\\Administrator\\Desktop\\input.txt")
	outputFile, _ := os.OpenFile("C:\\Users\\Administrator\\Desktop\\output.txt", os.O_WRONLY|os.O_CREATE, 0666)
